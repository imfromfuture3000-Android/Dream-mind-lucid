...
# Connect to Calypso Testnet
RPC_URL = "https://testnet.skalenodes.com/v1/giant-half-dual-testnet"
CHAIN_ID = 974399131

print("🔌 Connecting to SKALE Calypso Testnet...")
...
# Build constructor transaction with minimal gas price and legacy format
constructor_txn = Contract.constructor().build_transaction({
    "chainId": CHAIN_ID,
    "gas": 1000000,
    "gasPrice": 1,  # Minimal gas price
    "nonce": nonce,
})
...
if len(code) > 0:
    ...
    with open("skale_calypso_deployment.json", "w") as f:
        json.dump(deployment_info, f, indent=2)
    print("📝 Deployment information saved to skale_calypso_deployment.json")
