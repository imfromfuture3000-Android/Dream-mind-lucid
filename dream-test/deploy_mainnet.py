...
# Connect to Europa Mainnet
RPC_URL = "https://mainnet.skalenodes.com/v1/elated-tan-skat"
CHAIN_ID = 2046399126  # Europa Mainnet Chain ID

print("🔌 Connecting to SKALE Europa Mainnet...")
...
# Build constructor transaction with legacy format
...
if len(code) > 0:
    ...
    with open("skale_mainnet_deployment.json", "w") as f:
        json.dump(deployment_info, f, indent=2)
    print("📝 Deployment information saved to skale_mainnet_deployment.json")
    ...
    print(f"Network: SKALE Europa Mainnet")
